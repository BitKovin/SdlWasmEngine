...
function ___syscall_sendto(fd, message, length, flags, addr, addr_len) {
 if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(18, 0, 1, fd, message, length, flags, addr, addr_len);
 try {
  var sock = getSocketFromFD(fd);
...
var _mono_aot_vaudio_get_method = Module["_mono_aot_vaudio_get_method"] = a0 => (_mono_aot_vaudio_get_method = Module["_mono_aot_vaudio_get_method"] = wasmExports["mono_aot_vaudio_get_method"])(a0);

var _mono_aot_vaudio_wasm_get_method = Module["_mono_aot_vaudio_wasm_get_method"] = a0 => (_mono_aot_vaudio_wasm_get_method = Module["_mono_aot_vaudio_wasm_get_method"] = wasmExports["mono_aot_vaudio_wasm_get_method"])(a0);
