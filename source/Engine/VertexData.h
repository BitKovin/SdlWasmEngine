...
struct VertexData {
    ...
    float BlendIndices[4] = { 0, 0, 0, 0 };  // Changed to uint8_t for bgfx compatibility (bone indices are typically small)
    glm::vec4 BlendWeights = glm::vec4();
    glm::vec3 SmoothNormal = glm::vec3();
    glm::vec4 Color = glm::vec4(1.0f);
    glm::vec2 ShadowMapCoords = glm::vec2(0.0f);  // Fixed invalid default initialization
    ...
    static bgfx::VertexLayout Declaration() {
        ...
        layout
            ...
            .add(bgfx::Attrib::TexCoord1, 3, bgfx::AttribType::Float)  // Maps to SmoothNormal
            .add(bgfx::Attrib::Color0, 4, bgfx::AttribType::Float)
            .add(bgfx::Attrib::TexCoord2, 2, bgfx::AttribType::Float)  // Maps to ShadowMapCoords
            .end();
        return layout;
    }
};
